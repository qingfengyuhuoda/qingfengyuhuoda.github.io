    ...
    <div class="col-lg-12">
        ...
        <div class="item">
            <ul>
                ...
                <li><h4>Complete</h4><span>{{ authStore.info.achieve1 }}</span></li>
        ...
        <div class="item">
            <ul>
                ...
                <li><h4>Complete</h4><span>{{ authStore.info.achieve2 }}</span></li>
        ...
        <div class="item last-item">
            <ul>
                ...
                <li><h4></h4><span></span></li>
                <li><h4>Time</h4><span>no</span></li>
                <li><h4>Complete</h4><span>{{ authStore.info.achieve3 }}</span></li>
        ...
        <div class="item last-item">
            <ul>
                ...
                <li><h4></h4><span></span></li>
                <li><h4>Time</h4><span>no</span></li>
                <li><h4>Complete</h4><span>{{ authStore.info.achieve4 }}</span></li>
