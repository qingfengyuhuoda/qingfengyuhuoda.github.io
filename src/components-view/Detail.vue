  ...
  <div class="rowoutside">
    <div class="col-lg-12">
      <div class="page-content">
        ...
        <div class="rowoutside">
          <div class="col-lg-12">
            <div class="main-profile ">
              <div class="row">
                <div class="col-lg-4">
                  <img src="src/assets/images/2048Tiles.png" alt="" style="border-radius: 23px;">
                </div>
                <div class="col-lg-8 align-self-center">
                  <div class="main-info header-text">
                    <h4>单人游戏</h4>
                    <p>游戏界面为4*4的棋盘，使用wasd使所有格子向一个方向滑动，对于相同数字的两个格子，相撞时数字会相加，玩家每次滑动，空白处会随机刷新一个数字的格子，当界面全部被数字填满时，此时界面不可滑动，游戏结束，出现2048的数字时，游戏胜利</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="rowoutsideother">
          <div class="col-lg-12">
            <div class="main-profile ">
              <div class="row">
                <div class="col-lg-4">
                  <img src="src/assets/images/2048logo_1.png" alt="" style="border-radius: 23px;">
                </div>
                <div class="col-lg-8 align-self-center">
                  <div class="main-info header-text">
                    <h4>多人游戏</h4>
                    <p>在多人游戏中，我们加入了刺激的对抗环节，双方的得分改为对对方造成伤害，双方具有同样的血条，用生成的数块攻击对手，使用道具在一个最大且大于64的块生成效果，影响对手或增强自己，直到敌人血量为0，游戏胜利</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="newcontainer">
        <div class="rowoutsideother1">
          <div class="col-lg-12">
            <div class="main-profile ">
              <div class="row">
                <div class="col-lg-4">
                  <img src="src/assets/images/道具3.jpg" alt="" style="border-radius: 10px;">
                </div>
                <div class="col-lg-8 align-self-center">
                  <div class="main-info header-text">
                    <h4>行消除 按1或Z</h4>
                    <p>消除一行内的数块，并根据消除的数块对对手造成伤害</p>
                </div>
                </div>
              </div>
            </div>
        ...
        <div class="rowoutsideother1">
          <div class="col-lg-12">
            <div class="main-profile ">
              <div class="row">
                <div class="col-lg-4">
                  <img src="src/assets/images/道具2.jpg" alt="" style="border-radius: 10px;">
                </div>
                <div class="col-lg-8 align-self-center">
                  <div class="main-info header-text">
                    <h4>列消除 按2或X</h4>
                    <p>消除一列内的数块，并根据消除的数块对对手造成伤害</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="rowoutsideother1">
          <div class="col-lg-12">
            <div class="main-profile ">
              <div class="row">
                <div class="col-lg-4">
                  <img src="src/assets/images/道具1.jpg" alt="" style="border-radius: 10px;">
                </div>
                <div class="col-lg-8 align-self-center">
                  <div class="main-info header-text">
                    <h4>炸弹 按3或Q</h4>
                    <p>可以通过合并或点消除3*3范围内的数块，并根据消除的数块对对手造成伤害</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="rowoutsideother1">
          <div class="col-lg-12">
            <div class="main-profile ">
              <div class="row">
                <div class="col-lg-4">
                  <img src="src/assets/images/道具4.jpg" alt="" style="border-radius: 10px;">
                </div>
                <div class="col-lg-8 align-self-center">
                  <div class="main-info header-text">
                    <h4>治疗 按4或E</h4>
                    <p>双人对战，当你受伤时，使用会根据消除的数块恢复一定数目的生命值</p>
        ...
        <div class="rowoutsideother">
          <div class="col-lg-12">
            <div class="main-profile ">
              <div class="row">
                <div class="col-lg-4">
                  <img src="src/assets/images/道具5.jpg" alt="" style="border-radius: 10px;">
                </div>
                <div class="col-lg-8 align-self-center">
                  <div class="main-info header-text">
                    <h4>冰块 按F</h4>
                    <p>阻碍你的对手滑动，冰块不会由相同数字的两个格子相撞破坏，只能通过炸弹或行列消除破坏</p>
                  </div>
                </div>
              </div>
            </div>
...
@media (max-width: 992px) {
  ...
  .main-profile .main-info.header-text{
    text-align: left; 
  }
}
